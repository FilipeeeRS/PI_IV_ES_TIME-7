...
public class PedidoDeEditarMedicamento extends ComunicadoJson {
    ...
    @SerializedName("idMedicamento") // ID único do medicamento para ser editado
    ...
    public PedidoDeEditarMedicamento(String idMedicamento, String nome, String dia, String horario, String descricao, String idUsuario) {
        ...
        // Validação essencial, ID e usuário são necessários para identificar o que editar e quem está editando
        ...
        // Validação flexivel (Remover/Comentar), permite que campos de edição sejam nulos/vazios
